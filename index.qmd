...
O mesmo processo poderia ser feito igual ao *fill*, porém utilizando o comando color. Esse paramêtro também pode ser utilizado para diferênciar algum fator do data frame, apenas colocando dentro do *aes(color="coluna do data.frame")*. Nesse caso coloquei dentro da funçã *geom_boxplot()*, e coloquei o contorno do boxplot na cor azul.
