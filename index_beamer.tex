...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/Box-plot simplesx-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-14-1.pdf}}
\end{frame}
...
O exemplo abaixo é sem a coluna, apenas o \texttt{geom\_linerange}.

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-16-1.pdf}}
\end{frame}
...
Retornamos com o gráfico de barra com a média e as barras de desvio.
Para ajustar a escala de algum elemento gráfico no \texttt{ggplot} o
comando inicia
\texttt{scale\_{[}parâmetro{]}\_{[}característica\ do\ parâmetro\ ou\ tipo\ de\ função\ aplicada{]}()}.
No caso abaixo foi utilizado o \texttt{scale\_y\_continuous()}, já que
ajustaremos a escala do eixo y, sendo ela uma variável contínua. Dentro
da função colocaremos o seguinte agumento \texttt{limits=c(0,10)}, onde
zero é o limite inferior e o 10 o limite superior.

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/escala-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/escala-2.pdf}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-18-1.pdf}}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris}\SpecialCharTok{\%\textgreater{}\%}\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Species, }\AttributeTok{y=}\NormalTok{Petal.Length, }\AttributeTok{fill=}\NormalTok{Species))}\SpecialCharTok{+}\FunctionTok{geom\_boxplot}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris}\SpecialCharTok{\%\textgreater{}\%}\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Species, }\AttributeTok{y=}\NormalTok{Petal.Length, }\AttributeTok{fill=}\NormalTok{Species))}\SpecialCharTok{+}\FunctionTok{geom\_boxplot}\NormalTok{()}\SpecialCharTok{+}\FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values=}\FunctionTok{c}\NormalTok{(}\StringTok{"\#704c41"}\NormalTok{,}\StringTok{"\#41704f"}\NormalTok{,}\StringTok{"\#584170"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{Alterando elementos textuais no ggplot}
...
Para alterar o tipo fonte do gráficos é necessário usar o pacote
\texttt{extrafont}. Abaixo estará os comandos para instalar o pacote e
carrega-lo.
...
\textbf{Obs.:} esses elementos são importantes para garantir boa
visualização gráfica e seguir padrões gráficos de publicações ou
revistas.

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-20-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-20-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-20-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-22-1.pdf}}
\end{block}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-23-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-23-3.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-23-4.pdf}}
\end{block}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-24-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-25-2.pdf}}
\end{block}
\end{frame}

\begin{frame}[fragile]{Temas}
\phantomsection\label{temas}
O \texttt{ggplot2} por padrão dispõe de alguns temas para utilizar nos
gráficos, adicionando \texttt{theme\_}, aparece as sujestões disponíveis
do pacote. Através do comando \texttt{theme()}, pode-se editar o tema ou
criar temas novos.

Abaixo está os temas disponíveis do pacote \texttt{ggplot2}.

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/Box-plot tema-1.pdf}}
\end{frame}

\section{Unindo vários gráficos em uma imagem
só}\label{unindo-vuxe1rios-gruxe1ficos-em-uma-imagem-suxf3}

\begin{frame}[fragile]{Unindo vários gráficos em uma imagem só}
Em na seção do histograma vimos a função \texttt{facet\_grid} ou
\texttt{facet\_wrap}, para ter gráficos separados de acordo a uma
característica do \emph{data frame}. Porém como colocamos ggplots lado a
lado de diferentes \emph{data frame} para uma única imagem? Há algumas
opções, aqui irei mostrar utlizando o pacote \texttt{patchwork},

\begin{enumerate}
\item
  Armazenar os ggplots em um objeto utilizando o comando
  \texttt{\textless{}-} ou \texttt{=}, como mostra o exemplo abaixo
\item
  Escrever os nomes do objetos colocar \texttt{+} entre eles
\end{enumerate}

\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-26-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-31-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_beamer_files/figure-beamer/unnamed-chunk-31-3.pdf}}
\end{frame}
